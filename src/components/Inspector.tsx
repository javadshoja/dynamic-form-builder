...
import type { AnyField, RadioField, SelectField } from '@/types'
...
export function Inspector() {
  ...
  if (!field)
    return (
      <Card className="w-80 h-full rounded-none border-0 border-l">
              ...
              <>
                <div className="grid gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      update({ placeholder: e.target.value } as any)
                    }
                  />
                </div>
                <div className="grid gap-1.5">
